...
def absolute_distance(
    ...
    [absolute_distance in Rust documentation.](https://docs.rs/opendp/0.15.1-nightly.20260906.1/opendp/metrics/struct.AbsoluteDistance.html)
...
def l01inf_distance(
    ...
    [l01inf_distance in Rust documentation.](https://docs.rs/opendp/0.15.1-nightly.20260906.1/opendp/metrics/type.L01InfDistance.html)
...
def l02inf_distance(
    ...
    [l02inf_distance in Rust documentation.](https://docs.rs/opendp/0.15.1-nightly.20260906.1/opendp/metrics/type.L02InfDistance.html)
...
def l1_distance(
    ...
    [l1_distance in Rust documentation.](https://docs.rs/opendp/0.15.1-nightly.20260906.1/opendp/metrics/type.L1Distance.html)
...
def l2_distance(
    ...
    [l2_distance in Rust documentation.](https://docs.rs/opendp/0.15.1-nightly.20260906.1/opendp/metrics/type.L2Distance.html)
...
def linf_distance(
    ...
    [linf_distance in Rust documentation.](https://docs.rs/opendp/0.15.1-nightly.20260906.1/opendp/metrics/struct.LInfDistance.html)
