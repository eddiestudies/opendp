...
def as_array(
    ...
    # Call library function.
    lib_function = lib.opendp_core__as_array
    lib_function.argtypes = []
    lib_function.restype = FfiResult

    output = c_to_py(unwrap(lib_function(), Function))
    try:
        output.__opendp_dict__ = {
            '__function__': 'as_array',
            '__module__': 'core',
            '__kwargs__': {
...
def new_function(
    ...
    [new_function in Rust documentation.](https://docs.rs/opendp/0.15.1-nightly.20260906.1/opendp/core/struct.Function.html)
